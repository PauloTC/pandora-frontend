...
const Benefits = () => {
  return (
    <div className="bg-slate-50 px-4 py-10 xl:py-24">
      <div
        id="form-benefits"
        className="container mx-auto gap-12 grid lg:grid-cols-2 xl:gap-48"
      >
              ...
              return (
                <div key={index} className="flex gap-2">
                  <div className="pt-2">
                    ...
                    >
                      <path
                        d="M9.42609 0.619696L19.5769 7.89838V10.1804L9.50478 17.4L8.24577 15.7672C15.2687 10.6525 14.954 10.9279 16.4884 10.1804L0.927734 10.1804L0.927734 7.91806L16.4884 7.91806C15.3081 7.48527 14.954 7.1115 8.24577 2.33117L9.42609 0.619696Z"
                        fill="#E96767"
                      />
                    </svg>
                  </div>
